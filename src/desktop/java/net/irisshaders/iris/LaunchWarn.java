...
public class LaunchWarn {
	public static void main(String[] args) {
		...
		String message = DesktopBuildConfig.IS_SHARED_BETA
			...
			: "This file is the Forge version of pupil, meant to be installed as a mod. Would you like to get the NeoForge Installer instead?";
		String fallback = DesktopBuildConfig.IS_SHARED_BETA
			? "If you're seeing this, you didn't read instructions.\n (Hint: This isn't a installer or a Fabric mod. It's a (Neo)Forge mod.)"
			: "This file is the Forge version of pupil, meant to be installed as a mod. Please download the NeoForge Installer from https://neoforged.net.";
		if (GraphicsEnvironment.isHeadless()) {
			...
			if (Desktop.getDesktop().isSupported(Desktop.Action.BROWSE)) {
				int option = JOptionPane.showOptionDialog(null, message, "Pupil Installer", JOptionPane.YES_NO_OPTION, JOptionPane.INFORMATION_MESSAGE, null, null, null);
